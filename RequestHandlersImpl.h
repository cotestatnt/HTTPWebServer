...
public:
  FunctionRequestHandler(HTTPWebServer::THandlerFunction fn, HTTPWebServer::THandlerFunction ufn, const Uri &uri, HTTPMethod method)
...
//     log_debug("StaticRequestHandler::handle: request=%s _uri=%s\r\n", requestUri.c_str(), _uri.c_str());
...
//     }
//     log_debug("StaticRequestHandler::handle: path=%s, isFile=%d\r\n", path.c_str(), _isFile);
